...
NDefines.NDiplomacy.SUPPORT_REBELS_COST = 30 -- from 60, this is temporary to test in 1.34
NDefines.NDiplomacy.SPY_NETWORK_AE_EFFECT = -0.3 -- from -0.1, 1.34 change
